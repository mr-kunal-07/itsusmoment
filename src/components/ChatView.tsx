...
import { Send, Trash2, Lock, Reply, X, Check, CheckCheck, MoreVertical, Smile, Paperclip, Mic, Play, Pause, ArrowLeft, Image as ImageIcon, CheckSquare } from "lucide-react";
