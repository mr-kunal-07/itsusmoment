...
import {
  ...
  ChevronRight, MapPin, Play, ChevronDown, Smartphone, Layers, BookHeart,
} from
  "lucide-react";
...
const PLANS = [
  {
    ...
    features: [
      ...
      { text: "Private media folder", ok: true },
      { text: "Private chat + Call + Video Chat", ok: true },
      ...
      <header style={{
        ...
        <div style={{ maxWidth: 1180, margin: "0 auto", padding: "0 24px", height: 68, display: "flex", alignItems: "center", gap: 8 }}>
          ...
          <Link to="/" style={{ textDecoration: "none", display: "flex", alignItems: "center", flexShrink: 0 }}>
            ...
            <span style={{ ...SG, fontSize: 18, fontWeight: 700, color: C.ink, }}>usMoment</span>
          </Link>
        ...
        <div style={{ maxWidth: 860, margin: "0 auto", padding: "72px 24px 56px", textAlign: "center" }}>
          ...
          <Reveal>
            <div style={{ display: "inline-flex", alignItems: "center", gap: 7, background: C.roseLight, border: `1px solid ${C.roseMid}`, borderRadius: 99, padding: "6px 14px 6px 10px", marginBottom: 28 }}>
              ...
              <span style={{ fontSize: 12, fontWeight: 600, color: C.rose }}>Keep Private Until it's Permanent</span>
            </div>
          </Reveal>
          ...
          {/* Subheadline */}
          <Reveal delay={110}>
            <p className="text-[clamp(16px,2.4vw,20px)] leading-[1.50] text-gray-600 max-w-4xl mx-auto mb-9">
