...
import {
  ...
  Sparkles, Image, Mic, Bell, Users, ChevronRight } from
"lucide-react";
    ...
    <div style={{ background: T.bg, color: T.ink, fontFamily: "'Inter', system-ui, sans-serif", overflowX: "hidden", minHeight: "100vh" }}>
      ...
      <section style={{ background: T.white, paddingTop: 64 }}>
        <div style={{ maxWidth: 800, margin: "0 auto", padding: "80px 32px 64px", textAlign: "center" }}>
          ...
          {/* H1 */}
          <Reveal delay={60}>
            <h1 style={{ ...display, fontSize: "clamp(38px, 5vw, 62px)", lineHeight: 1.1, marginBottom: 24, maxWidth: 860, marginLeft: "auto", marginRight: "auto" }}>The private space your love  story  
...
<br />
          ...
          <Reveal delay={160}>
            <div style={{ display: "flex", flexWrap: "wrap", gap: 12, justifyContent: "center", marginBottom: 32 }}>
              <Link to="/auth" style={{ display: "inline-flex", alignItems: "center", gap: 8, fontWeight: 600, fontSize: 15, color: "#fff", background: T.ink, padding: "13px 28px", borderRadius: 12, textDecoration: "none", boxShadow: "0 2px 12px rgba(0,0,0,0.18)", transition: "opacity 0.15s" }} onMouseEnter={(e) => e.currentTarget.style.opacity = "0.85"}
              onMouseLeave={(e) => e.currentTarget.style.opacity = "1"}>
